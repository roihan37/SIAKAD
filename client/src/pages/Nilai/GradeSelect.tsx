...
import type { GradeOption } from "@/types/grades"
export function GradeSelect({ label, value, options, disabled, required, onChange }: { label: string; value: number | string | undefined; options: GradeOption[]; disabled?: boolean; required?: boolean; onChange: (value: string | undefined) => void }) {
  const id = useId()
